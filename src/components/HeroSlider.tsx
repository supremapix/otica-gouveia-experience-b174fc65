...
const slides = [
  ...
  {
    badge: '📍 SUA ÓTICA NO UMBARÁ',
    title: 'Sua Ótica no Umbará',
    subtitle: 'Umbará • Sítio Cercado • Xaxim • Bairros próximos',
    description: 'Atendemos toda a região do Umbará e Curitiba com qualidade e tecnologia',
