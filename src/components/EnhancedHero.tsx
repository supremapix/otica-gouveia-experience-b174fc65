      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
           <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <h3 className="text-white font-semibold mb-2">Medição Visioffice 3</h3>
              <p className="text-white/80 text-sm">Precisão digital na nossa loja no Umbará</p>
           </div>
           
           <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              <div className="text-3xl mb-3">🏍️</div>
              <h3 className="text-white font-semibold mb-2">Delivery Via Motoboy</h3>
              <p className="text-white/80 text-sm">Loja no Umbará, entregamos no seu bairro</p>
           </div>
