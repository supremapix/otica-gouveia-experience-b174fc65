...
const OticaContenda = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Contenda.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Contenda", url: "https://www.gouveiacuritiba.com.br/otica-contenda" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Contenda");
  const localBusinessData = createLocalBusinessSchema("Contenda");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança em Contenda com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega em Contenda acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-contenda"
        keywords="ótica contenda, óculos contenda, loja de óculos contenda pr, óculos de grau contenda"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Contenda"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Contenda
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Contenda"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Contenda é um município da Região Metropolitana de Curitiba conhecido por sua produção agrícola e crescimento econômico. A cidade valoriza serviços de qualidade que atendem às necessidades das famílias e trabalhadores locais, incluindo cuidados com a visão e saúde ocular.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores de Contenda oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Contenda.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Contenda
            </h2>
