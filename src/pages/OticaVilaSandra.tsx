...
const OticaVilaSandra = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20na%20Vila%20Sandra.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Vila Sandra", url: "https://www.gouveiacuritiba.com.br/otica-vila-sandra" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Vila Sandra");
  const localBusinessData = createLocalBusinessSchema("Vila Sandra");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança na Vila Sandra com óculos de grau, sol e lentes. Vendemos online com entrega na Vila Sandra acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-vila-sandra"
        keywords="ótica vila sandra, óculos vila sandra, loja de óculos vila sandra curitiba, óculos de grau vila sandra"
      ...
      <EnhancedHero
        title="Ótica Gouveia para a Vila Sandra"
        subtitle="Qualidade e Tradição para Toda a Família"
        location="Vila Sandra"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Confiança para a Vila Sandra
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Vila Sandra"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  A Vila Sandra é um bairro residencial de Curitiba, com forte vocação familiar e comunitária. Conhecida por suas ruas tranquilas e proximidade com centros comerciais, a Vila Sandra abriga famílias que valorizam qualidade de vida e bons serviços locais, incluindo serviços ópticos de confiança.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, atende moradores da Vila Sandra oferecendo óculos de grau, óculos de sol e lentes de contato com grande variedade de marcas e modelos. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente na Vila Sandra.
                </p>
                <p>
                  Nossa localização no Pinheirinho é estratégica e de fácil acesso. Você também pode comprar online e retirar em nossa loja física próxima ao Condor Umbará. Nosso compromisso é oferecer produtos de qualidade com atendimento familiar e acolhedor. Consulte-nos!
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos a Vila Sandra
            </h2>
