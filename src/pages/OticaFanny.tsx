...
const OticaFanny = () => {
  ...
  const breadcrumbData = createBreadcrumbStructuredData([
    ...
    { name: 'Fanny', url: 'https://www.gouveiacuritiba.com.br/otica-fanny' }
  ]);

  const opticalStoreData = createOpticalStoreSchema('Fanny');
  const localBusinessData = createLocalBusinessSchema('Fanny');
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  const whatsappUrl = "https://wa.me/5541999123456?text=Olá! Gostaria de agendar um exame de vista no Fanny.";
  ...
  return (
    <>
      <EnhancedSEO
        title="Ótica no Fanny - Curitiba | Ótica Gouveia"
        description="Ótica no Fanny com exames de vista gratuitos, armações de qualidade e lentes especializadas. Visite a Ótica Gouveia e tenha atendimento personalizado."
        keywords="ótica no fanny, óculos fanny, exame de vista fanny, ótica curitiba, lentes de grau curitiba"
        canonicalUrl="/otica-fanny"
        structuredData={structuredData}
        breadcrumbs={[
          { name: 'Início', url: '/' },
          { name: 'Óticas em Curitiba', url: '/oticas-curitiba' },
          { name: 'Fanny', url: '/otica-fanny' }
        ]}
      />
        ...
        <section className="pt-24 pb-16 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Sua ótica de confiança no Fanny com exames de vista gratuitos e atendimento especializado
            </p>
          ...
          <div className="container mx-auto">
            <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
                Atendendo o Fanny com Excelência
              </h2>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <p className="text-lg mb-6 text-muted-foreground">
                    A Ótica Gouveia no Fanny oferece atendimento especializado para toda a região, 
                  ...
                  <div className="bg-primary/10 p-6 rounded-lg">
                    <h3 className="font-semibold text-lg mb-3">Por que escolher nossa ótica no Fanny?</h3>
                    <ul className="space-y-2 text-muted-foreground">
                      <li>✓ Localização privilegiada no Fanny</li>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-primary/10 to-accent/10">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">
              Promoções Especiais Fanny
            </h2>
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold text-primary mb-4">
                🎯 Oferta Exclusiva Fanny
              </h3>
              <p className="text-lg mb-6">
                Na compra de qualquer armação, ganhe <strong>50% de desconto</strong> nas lentes!
              </p>
              <p className="text-sm text-muted-foreground mb-6">
                *Promoção válida apenas para moradores do Fanny mediante comprovação de endereço.
              </p>
              <a
                href={whatsappUrl}
                target="_blank"
