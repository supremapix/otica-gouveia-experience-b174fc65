...
const OticaLindoia = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20na%20Lindóia.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Lindóia", url: "https://www.gouveiacuritiba.com.br/otica-lindoia" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Lindóia");
  const localBusinessData = createLocalBusinessSchema("Lindóia");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Lindóia Curitiba | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança na Lindóia com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega na Lindóia acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-lindoia"
        keywords="ótica lindóia, óculos lindóia, loja de óculos lindóia curitiba, óculos de grau lindóia"
      ...
      <EnhancedHero
        title="Ótica Gouveia para a Lindóia"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para a Lindóia
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Lindóia"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  A Lindóia é um bairro tradicional de Curitiba, conhecido por sua infraestrutura residencial, comércio local e proximidade com importantes vias de acesso. O bairro atrai moradores que valorizam tranquilidade, praticidade e serviços de confiança.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores da Lindóia oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente na Lindóia.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos a Lindóia
            </h2>
