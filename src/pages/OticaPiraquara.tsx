...
const OticaPiraquara = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Piraquara.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Piraquara", url: "https://www.gouveiacuritiba.com.br/otica-piraquara" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Piraquara");
  const localBusinessData = createLocalBusinessSchema("Piraquara");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica em Piraquara PR | Óculos de Grau e Sol | Ótica Gouveia Curitiba"
        description="Ótica de confiança atendendo Piraquara com óculos de grau, sol e lentes. Vendemos online com entrega em Piraquara acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-piraquara"
        keywords="ótica piraquara, óculos piraquara, loja de óculos piraquara pr, óculos de grau piraquara, ótica região metropolitana"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Piraquara"
        subtitle="Tradição e Qualidade para a RMC"
        location="Piraquara - RMC"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Confiança Atendendo Piraquara
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia para Piraquara"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Piraquara é uma cidade estratégica da Região Metropolitana de Curitiba, conhecida por abrigar importantes mananciais de água que abastecem a capital. Com crescimento populacional constante e forte vocação residencial, a cidade demanda serviços ópticos de qualidade que atendam famílias e trabalhadores.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem orgulho de atender moradores de Piraquara oferecendo óculos de grau, óculos de sol e lentes de contato. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Piraquara, garantindo comodidade total.
                </p>
                <p>
                  Nossa localização no Pinheirinho facilita o acesso pela BR-116. Você também pode comprar online e retirar em nossa loja física próxima ao Condor Umbará. Consulte-nos!
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Piraquara
            </h2>
