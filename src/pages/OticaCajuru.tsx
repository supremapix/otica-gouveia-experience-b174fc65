        ...
        <section className="py-12 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Conheça o Bairro Cajuru
            </h2>
            <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/kKUWwNi9rYY"
                title="Vídeo sobre o bairro Cajuru em Curitiba"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
            </div>
            <p className="mt-4 text-brand-gray-700 text-center">
              O Cajuru é um bairro residencial tradicional de Curitiba, conhecido por sua tranquilidade e comércio local diversificado.
            </p>
          </div>
        </section>
