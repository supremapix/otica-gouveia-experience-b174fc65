...
const OticaCampoMagro = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Campo%20Magro.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Campo Magro", url: "https://www.gouveiacuritiba.com.br/otica-campo-magro" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Campo Magro");
  const localBusinessData = createLocalBusinessSchema("Campo Magro");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica em Campo Magro PR | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança atendendo Campo Magro com óculos de grau, sol e lentes. Vendemos online com entrega em Campo Magro acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-campo-magro"
        keywords="ótica campo magro, óculos campo magro, loja de óculos campo magro pr, óculos de grau campo magro"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Campo Magro"
        subtitle="Qualidade para a Região Metropolitana"
        location="Campo Magro - RMC"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Campo Magro
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia para Campo Magro"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Campo Magro é uma cidade da Região Metropolitana de Curitiba conhecida por sua tranquilidade, áreas verdes e proximidade com a capital paranaense. A cidade atrai famílias que buscam qualidade de vida e serviços de confiança para toda a família, incluindo cuidados com a saúde visual.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores de Campo Magro oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Campo Magro.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Campo Magro
            </h2>
