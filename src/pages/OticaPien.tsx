...
const OticaPien = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Piên.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Piên", url: "https://www.gouveiacuritiba.com.br/otica-pien" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Piên");
  const localBusinessData = createLocalBusinessSchema("Piên");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica em Piên PR | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança atendendo Piên com óculos de grau, sol e lentes. Vendemos online com entrega em Piên acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-pien"
        keywords="ótica piên, óculos piên, loja de óculos piên pr, óculos de grau piên"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Piên
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia para Piên"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Piên é uma cidade da Região Metropolitana de Curitiba conhecida por seu clima serrano e tranquilidade. A população local valoriza serviços de qualidade que atendem suas necessidades com praticidade e atendimento familiar.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, atende moradores de Piên oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Piên.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Piên
            </h2>
