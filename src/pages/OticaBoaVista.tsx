...
const OticaBoaVista = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20na%20Boa%20Vista.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Boa Vista", url: "https://www.gouveiacuritiba.com.br/otica-boa-vista" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Boa Vista");
  const localBusinessData = createLocalBusinessSchema("Boa Vista");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança na Boa Vista com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega na Boa Vista acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-boa-vista"
        keywords="ótica boa vista, óculos boa vista, loja de óculos boa vista curitiba, óculos de grau boa vista"
      ...
      <EnhancedHero
        title="Ótica Gouveia para a Boa Vista"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para a Boa Vista
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Boa Vista"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  A Boa Vista é um bairro tradicional de Curitiba, conhecido por sua localização estratégica, comércio diversificado e proximidade com importantes regiões da cidade. O bairro atrai moradores que valorizam acessibilidade, serviços de qualidade e atendimento familiar.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores da Boa Vista oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente na Boa Vista.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos a Boa Vista
            </h2>
