...
const OticaPilarzinho = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Pilarzinho.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Pilarzinho", url: "https://www.gouveiacuritiba.com.br/otica-pilarzinho" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Pilarzinho");
  const localBusinessData = createLocalBusinessSchema("Pilarzinho");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança no Pilarzinho com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega no Pilarzinho acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-pilarzinho"
        keywords="ótica pilarzinho, óculos pilarzinho, loja de óculos pilarzinho curitiba, óculos de grau pilarzinho"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Pilarzinho"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Pilarzinho
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Pilarzinho"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Pilarzinho é um bairro tradicional da região norte de Curitiba, conhecido por sua proximidade com o Parque São Lourenço e por sua comunidade familiar. O bairro atrai moradores que valorizam tranquilidade, áreas verdes e serviços de confiança para toda a família.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores do Pilarzinho oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Pilarzinho.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Pilarzinho
            </h2>
