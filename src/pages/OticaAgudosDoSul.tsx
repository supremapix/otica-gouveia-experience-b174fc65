...
const OticaAgudosDoSul = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Agudos%20do%20Sul.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Agudos do Sul", url: "https://www.gouveiacuritiba.com.br/otica-agudos-do-sul" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Agudos do Sul");
  const localBusinessData = createLocalBusinessSchema("Agudos do Sul");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica em Agudos do Sul PR | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança atendendo Agudos do Sul com óculos de grau, sol e lentes. Vendemos online com entrega em Agudos do Sul acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-agudos-do-sul"
        keywords="ótica agudos do sul, óculos agudos do sul, loja de óculos agudos do sul pr, óculos de grau agudos do sul"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Agudos do Sul"
        subtitle="Qualidade para a Região Metropolitana"
        location="Agudos do Sul - RMC"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Agudos do Sul
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia para Agudos do Sul"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Agudos do Sul é uma cidade da Região Metropolitana de Curitiba conhecida por suas belezas naturais, clima ameno e tranquilidade. A cidade atrai moradores que valorizam qualidade de vida e serviços de confiança para toda a família.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, atende moradores de Agudos do Sul oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Agudos do Sul.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Agudos do Sul
            </h2>
