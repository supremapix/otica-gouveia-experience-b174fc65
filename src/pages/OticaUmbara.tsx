...
const OticaUmbara = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Ótica Gouveia Umbarã - Centro de Excelência em Saúde Visual</title>
        <meta name="description" content="Ótica Gouveia Umbarã - Centro de excelência em saúde visual. Equipamentos modernos, profissionais especializados e atendimento VIP no Umbarã." />
        <meta name="keywords" content="ótica umbarã, centro excelência visual, óculos premium umbarã, optometrista umbarã" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-brand-gray-50 to-white">
          ...
          <div className="section-container relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-brand-red font-semibold">UMBARÃ - CURITIBA</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-bold text-brand-gray-900 mb-6">
                Ótica Gouveia <span className="text-brand-red">Umbarã</span>
              </h1>
              ...
              <p className="text-xl text-brand-gray-600 leading-relaxed">
                Nossa unidade principal no Umbarã concentra o que há de mais moderno em tecnologia, 
          ...
          <div className="section-container">
            <div className={`transition-all duration-1000 ease-out ${
              ...
              <h2 className="text-3xl font-bold text-brand-gray-900 mb-8 text-center">
                Centro de Excelência no Umbarã
              </h2>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-brand-gray-600 leading-relaxed mb-6">
                    O Umbarã abriga nossa unidade principal, um verdadeiro centro de excelência em saúde visual. Localizado estrategicamente para atender toda a região sul de Curitiba, incluindo Cajuru, Uberaba, Portão e Água Verde, nosso centro concentra os mais modernos equipamentos e profissionais mais experientes.
                  </p>
                  <p className="text-brand-gray-600 leading-relaxed">
                    Esta é nossa sede de inovação, onde desenvolvemos novos tratamentos, testamos as mais recentes tecnologias em lentes e oferecemos um atendimento premium que se tornou referência em Curitiba. No Umbarã, cada cliente recebe um cuidado personalizado e diferenciado.
                  </p>
                </div>
                <div className="bg-gradient-to-br from-brand-red/5 to-brand-blue/5 p-8 rounded-2xl">
                  <h4 className="text-xl font-semibold text-brand-gray-900 mb-4">Diferenciais do Centro Umbarã</h4>
        ...
        <section className="section-padding bg-brand-gray-50">
          <div className="section-container">
            <h2 className="text-3xl font-bold text-brand-gray-900 mb-12 text-center">
              Produtos Premium Disponíveis no Umbarã
            </h2>
        ...
        <section className="section-padding bg-white">
          <div className="section-container">
            <h2 className="text-3xl font-bold text-brand-gray-900 mb-12 text-center">
              Vantagens Exclusivas do Centro Umbarã
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <section className="section-padding bg-gradient-to-r from-brand-red to-brand-blue text-white">
          <div className="section-container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Serviços Exclusivos Centro Umbarã</h2>
        ...
        <section className="section-padding bg-brand-gray-900 text-white">
          <div className="section-container text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Venha conhecer nosso Centro de Excelência no Umbarã e descubra o que é ter um cuidado verdadeiramente diferenciado com sua visão
            </p>
