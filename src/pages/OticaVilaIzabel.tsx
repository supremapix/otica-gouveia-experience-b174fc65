...
const OticaVilaIzabel = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20na%20Vila%20Izabel.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Vila Izabel", url: "https://www.gouveiacuritiba.com.br/otica-vila-izabel" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Vila Izabel");
  const localBusinessData = createLocalBusinessSchema("Vila Izabel");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança na Vila Izabel com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega na Vila Izabel acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-vila-izabel"
        keywords="ótica vila izabel, óculos vila izabel, loja de óculos vila izabel curitiba, óculos de grau vila izabel"
      ...
      <EnhancedHero
        title="Ótica Gouveia para a Vila Izabel"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para a Vila Izabel
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Vila Izabel"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  A Vila Izabel é um bairro residencial da região leste de Curitiba, conhecido por sua tranquilidade, proximidade com o Centro e excelente infraestrutura. O bairro atrai famílias que valorizam qualidade de vida, segurança e serviços de confiança.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores da Vila Izabel oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente na Vila Izabel.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos a Vila Izabel
            </h2>
