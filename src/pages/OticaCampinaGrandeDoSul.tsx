...
const OticaCampinaGrandeDoSul = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Campina%20Grande%20do%20Sul.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Campina Grande do Sul", url: "https://www.gouveiacuritiba.com.br/otica-campina-grande-do-sul" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Campina Grande do Sul");
  const localBusinessData = createLocalBusinessSchema("Campina Grande do Sul");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Campina Grande do Sul | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança em Campina Grande do Sul com óculos de grau, sol e lentes. Vendemos online com entrega em Campina Grande do Sul acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-campina-grande-do-sul"
        keywords="ótica campina grande do sul, óculos campina grande do sul, loja de óculos campina grande do sul"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Campina Grande do Sul"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Campina Grande do Sul
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Campina Grande do Sul"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Campina Grande do Sul é uma cidade da Região Metropolitana de Curitiba conhecida por sua localização estratégica, desenvolvimento econômico e qualidade de vida. A cidade valoriza serviços de excelência que atendem às necessidades de sua população crescente, incluindo cuidados especializados com a visão.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores de Campina Grande do Sul oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Campina Grande do Sul.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Campina Grande do Sul
            </h2>
