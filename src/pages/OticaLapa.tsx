...
const OticaLapa = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20na%20Lapa.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Lapa", url: "https://www.gouveiacuritiba.com.br/otica-lapa" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Lapa");
  const localBusinessData = createLocalBusinessSchema("Lapa");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança na Lapa com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega na Lapa acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-lapa"
        keywords="ótica lapa, óculos lapa, loja de óculos lapa pr, óculos de grau lapa"
      ...
      <EnhancedHero
        title="Ótica Gouveia para a Lapa"
        subtitle="História, Cultura e Qualidade em Óculos"
        location="Lapa"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para a Lapa
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Lapa"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  A Lapa é uma cidade histórica da Região Metropolitana de Curitiba, reconhecida por seu patrimônio cultural, arquitetura colonial e importância na história do Paraná. A cidade valoriza tradição, qualidade e serviços que atendem às necessidades das famílias locais, incluindo cuidados com a visão.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem orgulho de atender moradores da Lapa oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente na Lapa.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos a Lapa
            </h2>
