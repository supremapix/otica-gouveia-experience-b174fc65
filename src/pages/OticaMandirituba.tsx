...
const OticaMandirituba = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Mandirituba.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Mandirituba", url: "https://www.gouveiacuritiba.com.br/otica-mandirituba" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Mandirituba");
  const localBusinessData = createLocalBusinessSchema("Mandirituba");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Mandirituba | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança em Mandirituba com óculos de grau, sol e lentes. Vendemos online com entrega em Mandirituba acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-mandirituba"
        keywords="ótica mandirituba, óculos mandirituba, loja de óculos mandirituba, óculos de grau mandirituba"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Mandirituba"
        subtitle="Tradição e Qualidade em Óculos"
        location="Mandirituba"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Mandirituba
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Mandirituba"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Mandirituba é uma cidade da Região Metropolitana de Curitiba conhecida por sua vocação agrícola, paisagens naturais e comunidade acolhedora. Com crescimento constante, a cidade valoriza serviços de qualidade que atendem às necessidades das famílias locais, incluindo cuidados com a saúde visual.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores de Mandirituba oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Mandirituba.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Mandirituba
            </h2>
