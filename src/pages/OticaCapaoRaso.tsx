...
const OticaCapaoRaso = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Capão%20Raso.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Capão Raso", url: "https://www.gouveiacuritiba.com.br/otica-capao-raso" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Capão Raso");
  const localBusinessData = createLocalBusinessSchema("Capão Raso");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Capão Raso Curitiba | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança no Capão Raso com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega no Capão Raso acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-capao-raso"
        keywords="ótica capão raso, óculos capão raso, loja de óculos capão raso curitiba, óculos de grau capão raso"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Capão Raso"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Capão Raso
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Capão Raso"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Capão Raso é um bairro em crescimento na região sul de Curitiba, conhecido por sua comunidade familiar, comércio diversificado e excelente localização próxima a importantes vias de acesso. O bairro atrai moradores que buscam qualidade de vida, praticidade e serviços de confiança para toda a família.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores do Capão Raso oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Capão Raso.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Capão Raso
            </h2>
