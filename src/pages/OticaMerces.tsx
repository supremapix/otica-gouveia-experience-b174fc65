...
const OticaMerces = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20nas%20Mercês.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Mercês", url: "https://www.gouveiacuritiba.com.br/otica-merces" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Mercês");
  const localBusinessData = createLocalBusinessSchema("Mercês");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Mercês Curitiba | Óculos de Grau e Sol Premium | Ótica Gouveia"
        description="Ótica de excelência nas Mercês com óculos de grau, sol e lentes premium. Vendemos online com entrega nas Mercês acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-merces"
        keywords="ótica mercês, óculos mercês, loja de óculos mercês curitiba, óculos de grau mercês"
      ...
      <EnhancedHero
        title="Ótica Gouveia para as Mercês"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para as Mercês
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Mercês"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  As Mercês são um bairro tradicional e valorizado de Curitiba, conhecido por sua arquitetura histórica, proximidade com o Centro e por abrigar residências e instituições de prestígio. O bairro atrai moradores que valorizam tradição, elegância e acesso a serviços de qualidade superior.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem orgulho de atender moradores das Mercês oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente nas Mercês.
                </p>
                <p>
                  Você também pode comprar online e retirar em nossa loja física no Pinheirinho, próxima ao Condor Umbará. Nosso compromisso é oferecer produtos premium com atendimento personalizado que conquistou gerações. Consulte-nos!
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos as Mercês
            </h2>
