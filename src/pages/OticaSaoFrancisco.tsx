...
const OticaSaoFrancisco = () => {
  ...
  const breadcrumbData = createBreadcrumbStructuredData([
    ...
    { name: 'São Francisco', url: 'https://www.gouveiacuritiba.com.br/otica-sao-francisco' }
  ]);

  const opticalStoreData = createOpticalStoreSchema('São Francisco');
  const localBusinessData = createLocalBusinessSchema('São Francisco');
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  const whatsappUrl = "https://wa.me/5541999123456?text=Olá! Gostaria de agendar um exame de vista em São Francisco.";
  ...
  return (
    <>
      <EnhancedSEO
        title="Ótica em São Francisco - Curitiba | Ótica Gouveia"
        description="Ótica em São Francisco com exames de vista gratuitos, armações de qualidade e lentes especializadas. Visite a Ótica Gouveia e tenha atendimento personalizado."
        keywords="ótica em são francisco, óculos são francisco, exame de vista são francisco, ótica curitiba, lentes de grau curitiba"
        canonicalUrl="/otica-sao-francisco"
        structuredData={structuredData}
        breadcrumbs={[
          { name: 'Início', url: '/' },
          { name: 'Óticas em Curitiba', url: '/oticas-curitiba' },
          { name: 'São Francisco', url: '/otica-sao-francisco' }
        ]}
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20">
        ...
        <section className="pt-24 pb-16 px-4">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              Ótica em São Francisco
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Sua ótica de confiança em São Francisco com exames de vista gratuitos e atendimento especializado
            </p>
          ...
          <div className="container mx-auto">
            <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
                Atendendo São Francisco com Excelência
              </h2>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <p className="text-lg mb-6 text-muted-foreground">
                    A Ótica Gouveia em São Francisco oferece atendimento especializado para toda a região, 
                  ...
                  <div className="bg-primary/10 p-6 rounded-lg">
                    <h3 className="font-semibold text-lg mb-3">Por que escolher nossa ótica em São Francisco?</h3>
                    <ul className="space-y-2 text-muted-foreground">
                      <li>✓ Localização privilegiada em São Francisco</li>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Vantagens Exclusivas em São Francisco
            </h2>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-primary/10 to-accent/10">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">
              Promoções Especiais São Francisco
            </h2>
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold text-primary mb-4">
                🎯 Oferta Exclusiva São Francisco
              </h3>
              <p className="text-lg mb-6">
                Na compra de qualquer armação, ganhe <strong>50% de desconto</strong> nas lentes!
              </p>
              <p className="text-sm text-muted-foreground mb-6">
                *Promoção válida apenas para moradores de São Francisco mediante comprovação de endereço.
              </p>
              <a
                href={whatsappUrl}
                target="_blank"
        ...
        <section className="py-16 px-4 bg-primary text-white">
          <div className="container mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Visite Nossa Ótica em São Francisco
            </h2>
