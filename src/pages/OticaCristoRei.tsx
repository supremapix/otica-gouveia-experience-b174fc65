...
const OticaCristoRei = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Cristo%20Rei.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Cristo Rei", url: "https://www.gouveiacuritiba.com.br/otica-cristo-rei" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Cristo Rei");
  const localBusinessData = createLocalBusinessSchema("Cristo Rei");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        ...
        description="Ótica de confiança no Cristo Rei com óculos de grau, sol e lentes. Vendemos online com entrega no Cristo Rei acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-cristo-rei"
        keywords="ótica cristo rei, óculos cristo rei, loja de óculos cristo rei curitiba, óculos de grau cristo rei"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Cristo Rei"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Cristo Rei
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Cristo Rei"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Cristo Rei é um bairro tradicional de Curitiba conhecido por sua localização estratégica, infraestrutura completa e forte presença comercial. O bairro abriga famílias, profissionais e estudantes que valorizam qualidade e praticidade em serviços ópticos de confiança.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, atende moradores do Cristo Rei oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Cristo Rei.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Cristo Rei
            </h2>
