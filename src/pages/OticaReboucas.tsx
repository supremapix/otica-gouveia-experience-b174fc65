...
const OticaReboucas = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Rebouças.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Rebouças", url: "https://www.gouveiacuritiba.com.br/otica-reboucas" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Rebouças");
  const localBusinessData = createLocalBusinessSchema("Rebouças");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Rebouças Curitiba | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança no Rebouças com óculos de grau, sol e lentes. Vendemos online com entrega no Rebouças acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-reboucas"
        keywords="ótica rebouças, óculos rebouças, loja de óculos rebouças curitiba, óculos de grau rebouças, óculos de sol rebouças"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Rebouças"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Rebouças
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Rebouças"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Rebouças é um bairro central e estratégico de Curitiba, conhecido por sua localização privilegiada e fácil acesso a diversas regiões da cidade. Com forte presença comercial e residencial, o bairro abriga profissionais, estudantes e famílias que valorizam qualidade e praticidade em serviços ópticos.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição, atende moradores do Rebouças oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Rebouças. Nossa localização no Pinheirinho é de fácil acesso.
                </p>
                <p>
                  Você também pode comprar online e retirar em nossa loja física próxima ao Condor Umbará. Nosso compromisso é oferecer produtos de qualidade com atendimento familiar que conquistou gerações. Consulte-nos!
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Rebouças
            </h2>
