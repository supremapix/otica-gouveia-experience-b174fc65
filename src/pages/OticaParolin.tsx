...
const OticaParolin = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Parolin.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Parolin", url: "https://www.gouveiacuritiba.com.br/otica-parolin" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Parolin");
  const localBusinessData = createLocalBusinessSchema("Parolin");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Parolin Curitiba | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança no Parolin com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega no Parolin acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-parolin"
        keywords="ótica parolin, óculos parolin, loja de óculos parolin curitiba, óculos de grau parolin"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Parolin"
        subtitle="Tradição e Acessibilidade em Óculos"
        location="Parolin"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Parolin
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Parolin"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Parolin é um bairro tradicional e bem localizado de Curitiba, conhecido por sua vocação comercial e industrial, além da proximidade com o Centro da cidade. O bairro abriga trabalhadores, famílias e empresas que valorizam praticidade, acessibilidade e serviços de confiança.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores do Parolin oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Parolin.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Parolin
            </h2>
