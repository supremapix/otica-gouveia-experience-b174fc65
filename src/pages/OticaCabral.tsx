...
const OticaCabral = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Cabral.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Cabral", url: "https://www.gouveiacuritiba.com.br/otica-cabral" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Cabral");
  const localBusinessData = createLocalBusinessSchema("Cabral");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Cabral Curitiba | Óculos de Grau e Sol Premium | Ótica Gouveia"
        description="Ótica de excelência no Cabral com óculos de grau, sol e lentes premium. Vendemos online com entrega no Cabral acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-cabral"
        keywords="ótica cabral, óculos cabral, loja de óculos cabral curitiba, óculos de grau cabral"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Cabral"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Cabral
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Cabral"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Cabral é um bairro tradicional e valorizado de Curitiba, conhecido por sua proximidade com o Parque Barigui, uma das áreas verdes mais importantes da cidade. O bairro atrai moradores que valorizam qualidade de vida, tranquilidade e acesso a serviços de confiança, além de profissionais que trabalham na região central.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores do Cabral oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Cabral.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Cabral
            </h2>
