...
const OticaTaruma = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20no%20Tarumã.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Tarumã", url: "https://www.gouveiacuritiba.com.br/otica-taruma" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Tarumã");
  const localBusinessData = createLocalBusinessSchema("Tarumã");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica Tarumã Curitiba | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança no Tarumã com óculos de grau, sol e lentes de qualidade. Vendemos online com entrega no Tarumã acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-taruma"
        keywords="ótica tarumã, óculos tarumã, loja de óculos tarumã curitiba, óculos de grau tarumã"
      ...
      <EnhancedHero
        title="Ótica Gouveia para o Tarumã"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para o Tarumã
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia Tarumã"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  O Tarumã é um bairro em expansão na região norte de Curitiba, conhecido por suas áreas verdes, crescimento residencial e excelente infraestrutura. O bairro atrai famílias que buscam qualidade de vida, tranquilidade e proximidade com a natureza, valorizando serviços de confiança e qualidade.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição em Curitiba, tem o prazer de atender moradores do Tarumã oferecendo óculos de grau, óculos de sol e lentes de contato das melhores marcas nacionais e importadas. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente no Tarumã.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos o Tarumã
            </h2>
