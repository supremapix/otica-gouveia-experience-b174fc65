...
const OticaCampoLargo = () => {
  ...
  const whatsappUrl = "https://wa.me/554131140663?text=Olá!%20Vim%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20óculos%20em%20Campo%20Largo.";
  ...
  const breadcrumbData = createBreadcrumbSchema([
    ...
    { name: "Ótica Campo Largo", url: "https://www.gouveiacuritiba.com.br/otica-campo-largo" }
  ]);

  const opticalStoreData = createOpticalStoreSchema("Campo Largo");
  const localBusinessData = createLocalBusinessSchema("Campo Largo");
  const structuredData = [breadcrumbData, opticalStoreData, localBusinessData];

  return (
    <div className="min-h-screen flex flex-col bg-white">
      <EnhancedSEO
        title="Ótica em Campo Largo PR | Óculos de Grau e Sol | Ótica Gouveia"
        description="Ótica de confiança atendendo Campo Largo com óculos de grau, sol e lentes. Vendemos online com entrega em Campo Largo acima de R$250. Consulte-nos!"
        canonicalUrl="/otica-campo-largo"
        keywords="ótica campo largo, óculos campo largo, loja de óculos campo largo pr, óculos de grau campo largo"
      ...
      <EnhancedHero
        title="Ótica Gouveia para Campo Largo"
        subtitle="Qualidade para a Região Metropolitana"
        location="Campo Largo - RMC"
      ...
      <main className="flex-grow">
        <section className="py-16 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6">
              Ótica de Referência para Campo Largo
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <img 
                  src="/lovable-uploads/2c54c0af-f957-4477-b0ec-ea572976132f.png" 
                  alt="Ótica Gouveia para Campo Largo"
                  className="rounded-lg shadow-lg w-full"
                />
              </div>
              <div className="space-y-4 text-brand-gray-700 text-lg leading-relaxed">
                <p>
                  Campo Largo é uma cidade importante da Região Metropolitana de Curitiba, conhecida por seu polo industrial cerâmico e pela produção agrícola. Com população diversificada de trabalhadores, comerciantes e famílias, a cidade demanda serviços ópticos acessíveis e de qualidade.
                </p>
                <p>
                  A Ótica Gouveia, com mais de 40 anos de tradição, atende moradores de Campo Largo oferecendo óculos de grau, óculos de sol e lentes de contato. Vendemos online com entrega via motoboy para compras acima de R$ 250,00 diretamente em Campo Largo.
                </p>
                <p>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-gray-900 mb-6 text-center">
              Entre em Contato - Atendemos Campo Largo
            </h2>
