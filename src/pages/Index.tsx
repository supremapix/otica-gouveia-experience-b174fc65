              ...
              >
                <CarouselContent>
                  {[
                    ...
                    { name: 'Fanny', slug: '/otica-fanny' },
                    { name: 'São Francisco', slug: '/otica-sao-francisco' },
                    { name: 'Barigui', slug: '/otica-barigui' },
                    { name: 'Centro Cívico', slug: '/otica-centro-civico' },
                    { name: 'Capão da Imbuia', slug: '/otica-capao-da-imbuia' },
                    { name: 'Santa Quitéria', slug: '/otica-santa-quiteria' },
                    { name: 'Mossunguê', slug: '/otica-mossungue' },
                    { name: 'Seminário', slug: '/otica-seminario' },
                    { name: 'Barreirinha', slug: '/otica-barreirinha' },
                    { name: 'Santo Inácio', slug: '/otica-santo-inacio' },
                    { name: 'São Lourenço', slug: '/otica-sao-lourenco' },
                    { name: 'Riviera', slug: '/otica-riviera' },
                    { name: 'Campo de Santana', slug: '/otica-campo-de-santana' },
                    { name: 'Augusta', slug: '/otica-augusta' },
                    { name: 'Cascatinha', slug: '/otica-cascatinha' },
                    { name: 'Vila Guaíra', slug: '/otica-vila-guaira' },
                  ].map((bairro) => (
