...
export const neighborhoodData: Record<string, NeighborhoodData> = {
  ...
  'pinheirinho': {
    ...
    metaDescription: 'Ótica no Umbará em Curitiba. Nossa loja física: Rua Nicola Pellanda, 1286. Óculos de grau, sol, lentes de contato. Medição Visioffice 3 inclusa!',
    ...
    description: [
      ...
      'Nossa equipe especializada oferece serviços completos de ótica: medição de alta precisão com Visioffice 3, confecção de óculos de grau com lentes monofocais e multifocais progressivas, tratamentos anti-reflexo e fotocromático, óculos de sol originais com proteção UV 400, lentes de contato gelatinosas e rígidas para todas as necessidades, e assistência técnica especializada com ajustes e consertos. Trabalhamos com laboratórios parceiros que garantem precisão na fabricação dos seus óculos. Após seu pedido feito, informamos o prazo e a data de entrega, pois o tempo de fabricação pode variar conforme o tipo de lente escolhida.',
  ...
  'sitio-cercado': {
    ...
    metaDescription: 'Ótica para o Sítio Cercado em Curitiba. Loja no Umbará com entrega via motoboy. Óculos de grau, sol e lentes de contato. Compras acima de R$250 com entrega inclusa!',
    keywords: [
    ...
    heroSubtitle: 'Loja no Umbará — Motoboy Entrega no Seu Bairro!',
    description: [
      ...
      'Nossa loja física está localizada no Umbará, na Rua Nicola Pellanda 1286 - apenas 10 minutos do Sítio Cercado via Rua Izaac Ferreira da Cruz ou Rua Tijucas do Sul. Para maior comodidade dos moradores do Sítio Cercado, entregamos via motoboy para compras acima de R$ 250,00. Isso significa que você pode fazer seu exame de vista em nossa loja, escolher seus óculos com calma, e receber tudo no conforto da sua casa no Sítio Cercado! Atendemos toda a extensão do bairro, desde as proximidades da Rua Izaac Ferreira da Cruz até as áreas mais ao sul próximas ao Ganchinho e Campo de Santana.',
  ...
  'juveve': {
    ...
    description: [
      'Moradores do Juvevê, a Ótica Gouveia oferece elegância para um dos bairros mais charmosos de Curitiba! O Juvevê é um bairro residencial tradicional e nobre, conhecido por suas ruas arborizadas, casas históricas com jardins bem cuidados e moradores que valorizam sofisticação e qualidade de vida. Com mais de 40 anos de tradição no mercado óptico curitibano, a Ótica Gouveia atende clientes exigentes do Juvevê com marcas premium e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos de alto padrão: exame de vista gratuito com tecnologia moderna para diagnóstico preciso, confecção de óculos de grau com lentes das melhores marcas incluindo Zeiss, Hoya e Varilux. Disponibilizamos tratamentos premium como anti-reflexo Crizal, proteção contra luz azul, lentes fotocromáticas Transitions e proteção UV total. Trabalhamos também com lentes de contato diárias premium e multifocais para todas as necessidades visuais.',
      'No Juvevê você encontra as grifes mais sofisticadas do mercado óptico: Ray-Ban com modelos clássicos e modernos, Oakley para esportes, Persol italiano, Arnette, Chilli Beans e diversas armações de designer. A Ótica Gouveia se diferencia pelo atendimento refinado - ajudamos você a escolher a armação perfeita que combine com a elegância tradicional do seu bairro. Parcelamos em até 12x sem juros, aceitamos os principais convênios e planos de saúde.',
      'O Juvevê está localizado em posição privilegiada em Curitiba, próximo ao Centro Cívico, Cabral, Hugo Lange e Alto da Glória. O bairro é conhecido por suas residências históricas, ruas tranquilas e atmosfera residencial de alto padrão. A Ótica Gouveia entrega em todo o Juvevê e bairros adjacentes, garantindo praticidade para clientes que valorizam seu tempo e exigem qualidade em produtos ópticos.',
      'Cliente do Juvevê, cuide da sua visão com quem entende de tradição! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita no Juvevê para compras acima de R$ 250,00. Ótica Gouveia Juvevê - elegância e qualidade em óculos há mais de 40 anos!'
    ],
  ...
  'jardim-das-americas': {
    ...
    description: [
      'Estudantes e moradores do Jardim das Américas, a Ótica Gouveia é sua parceira em cuidados visuais! O Jardim das Américas é um bairro com forte presença universitária em Curitiba, localizado na zona leste próximo a importantes faculdades e universidades. Com ambiente jovem e dinâmico, o bairro abriga estudantes, professores e famílias que buscam qualidade com preços acessíveis. Com mais de 40 anos de tradição, a Ótica Gouveia oferece atendimento especializado e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para quem estuda e trabalha intensamente: exame de vista gratuito com equipamentos modernos, confecção de óculos de grau com lentes anti-fadiga ideais para longas horas de estudo e leitura, opções monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos essenciais como anti-reflexo para aulas à noite, proteção contra luz azul de computadores e celulares, lentes fotocromáticas Transitions e proteção UV 400. Trabalhamos também com lentes de contato de diversas marcas.',
      'No Jardim das Américas você encontra armações modernas e acessíveis: Ray-Ban, Oakley, Arnette, Chilli Beans e diversas opções nacionais de qualidade com ótimo custo-benefício. A Ótica Gouveia oferece condições especiais para estudantes - apresente sua carteirinha e aproveite descontos exclusivos. Parcelamos em até 12x sem juros, aceitamos convênios e planos de saúde, facilitando o pagamento para quem está na fase de estudos.',
      'O Jardim das Américas está localizado na zona leste de Curitiba, próximo ao Cajuru, Capão da Imbuia, Guabirotuba e com fácil acesso às universidades da região. O bairro possui infraestrutura completa, comércio variado e transporte público eficiente. A Ótica Gouveia atende toda essa comunidade universitária e familiar com qualidade comprovada por décadas de atuação.',
      'Estudante do Jardim das Américas, cuide da sua visão para render mais nos estudos! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita no Jardim das Américas para compras acima de R$ 250,00. Ótica Gouveia - qualidade e preço justo para estudantes há mais de 40 anos!'
    ],
  ...
  'novo-mundo': {
    ...
    description: [
      'Moradores do Novo Mundo, a Ótica Gouveia é sua referência em óculos de grau, sol e lentes de contato na região sul de Curitiba! O Novo Mundo é um bairro residencial e comercial estratégico, conhecido por sua localização privilegiada, fácil acesso e proximidade com importantes vias da cidade. Com mais de 40 anos de tradição no mercado óptico curitibano, a Ótica Gouveia oferece atendimento de excelência para toda a comunidade do Novo Mundo, com nossa loja no Pinheirinho a apenas 10 minutos de distância e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos: exame de vista gratuito realizado com equipamentos de última geração para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes monofocais para miopia, hipermetropia e astigmatismo, lentes bifocais e multifocais progressivas. Disponibilizamos tratamentos de alta tecnologia como anti-reflexo multicamadas, proteção contra luz azul de telas, lentes fotocromáticas Transitions e proteção UV 400. Trabalhamos também com ampla linha de lentes de contato gelatinosas e rígidas.',
      'No Novo Mundo você encontra as melhores marcas do mercado óptico com preços justos: Ray-Ban com modelos clássicos e modernos, Oakley para esportes, Arnette, Chilli Beans e diversas armações nacionais e importadas de excelente qualidade. A Ótica Gouveia se diferencia pelo atendimento familiar e acolhedor - cada cliente recebe atenção individual para escolher a armação ideal. Parcelamos em até 12x sem juros, aceitamos os principais convênios e planos de saúde.',
      'O Novo Mundo possui excelente localização na região sul de Curitiba, com fácil acesso pela Av. República Argentina e proximidade com Portão, Capão Raso e Pinheirinho. O bairro conta com comércio diversificado, boa infraestrutura e transporte público eficiente. A Ótica Gouveia atende moradores de toda essa região com qualidade comprovada por décadas de atuação no mercado curitibano.',
      'Morador do Novo Mundo, cuide da sua visão com quem entende! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e descubra por que somos a ótica de confiança de milhares de famílias. Entrega gratuita no Novo Mundo para compras acima de R$ 250,00. Funcionamos de segunda a sexta das 9h às 18h e sábados das 9h às 13h. Ótica Gouveia Novo Mundo - tradição, qualidade e praticidade há mais de 40 anos!'
    ],
  ...
  'taruma': {
    ...
    description: [
      'Moradores do Tarumã, a Ótica Gouveia oferece qualidade para quem vive próximo à natureza! O Tarumã é um bairro tranquilo e arborizado de Curitiba, localizado na zona leste e conhecido pelo Parque Municipal do Iguaçu, suas áreas verdes preservadas e qualidade de vida. Moradores do Tarumã valorizam o contato com a natureza e buscam serviços de confiança. Com mais de 40 anos de tradição, a Ótica Gouveia oferece atendimento de excelência e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para quem adora atividades ao ar livre: exame de vista gratuito com equipamentos modernos, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos especiais como anti-reflexo multicamadas, proteção contra luz azul de dispositivos, lentes fotocromáticas Transitions perfeitas para passeios no parque e óculos de sol com proteção UV 400 para caminhadas e esportes ao ar livre.',
      'No Tarumã você encontra óculos perfeitos para curtir a natureza: Ray-Ban com modelos clássicos, Oakley ideais para esportes e atividades outdoor, Arnette, Chilli Beans e diversas armações nacionais e importadas. A Ótica Gouveia se diferencia pelo atendimento personalizado - ajudamos você a escolher óculos de sol esportivos e óculos de grau para todas as ocasiões. Parcelamos em até 12x sem juros, aceitamos convênios e planos de saúde.',
      'O Tarumã está localizado na zona leste de Curitiba, próximo ao Parque Municipal do Iguaçu, Cajuru, Uberaba e Jardim das Américas. O bairro é valorizado por moradores que buscam qualidade de vida em ambiente tranquilo e arborizado. A região conta com boa infraestrutura e fácil acesso às principais vias da cidade. A Ótica Gouveia entrega em todo o Tarumã e bairros vizinhos com qualidade e pontualidade.',
      'Morador do Tarumã, cuide da sua visão para aproveitar melhor o parque! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita no Tarumã para compras acima de R$ 250,00. Ótica Gouveia Tarumã - qualidade para quem ama natureza há mais de 40 anos!'
    ],
  ...
  'lindoia': {
    ...
    description: [
      'Moradores do Lindóia, a Ótica Gouveia é sua parceira em cuidados visuais de qualidade! O Lindóia é um bairro residencial encantador de Curitiba, localizado na região oeste, conhecido por suas ruas arborizadas, casas aconchegantes e moradores que valorizam tranquilidade e qualidade de vida. Com mais de 40 anos de tradição no mercado óptico curitibano, a Ótica Gouveia oferece atendimento personalizado para toda a comunidade do Lindóia, com entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para atender todas as suas necessidades: exame de vista gratuito realizado com equipamentos modernos para diagnóstico preciso, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos especiais como anti-reflexo multicamadas, proteção contra luz azul de telas, lentes fotocromáticas Transitions e proteção UV 400. Trabalhamos também com lentes de contato de diversas marcas para todas as necessidades visuais.',
      'No Lindóia você encontra as melhores marcas do mercado óptico: Ray-Ban com modelos clássicos e modernos, Oakley para esportes, Arnette, Chilli Beans e diversas armações nacionais e importadas de qualidade. A Ótica Gouveia se diferencia pelo atendimento familiar e acolhedor - cada cliente recebe atenção individual para escolher a armação perfeita. Parcelamos em até 12x sem juros, aceitamos os principais convênios e planos de saúde, com condições especiais para pagamento à vista.',
      'O Lindóia está localizado na região oeste de Curitiba, próximo ao Santa Felicidade, Vista Alegre, Pilarzinho e Bom Retiro. O bairro é conhecido por sua atmosfera residencial tranquila, ruas arborizadas e boa infraestrutura. A Ótica Gouveia entrega em todo o Lindóia e bairros vizinhos, garantindo praticidade para famílias que valorizam qualidade e conforto.',
      'Morador do Lindóia, cuide da sua visão com tradição e qualidade! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita no Lindóia para compras acima de R$ 250,00. Ótica Gouveia Lindóia - qualidade familiar há mais de 40 anos!'
    ],
  ...
  'sao-joao': {
    ...
    description: [
      'Moradores do São João, a Ótica Gouveia oferece qualidade para um dos bairros mais bem localizados de Curitiba! O São João é um bairro residencial tradicional, posicionado estrategicamente próximo ao Mercês, Centro e Batel, conhecido por sua tranquilidade, casas charmosas e moradores que valorizam praticidade e bons serviços. Com mais de 40 anos de tradição no mercado óptico curitibano, a Ótica Gouveia atende toda a comunidade do São João com excelência e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos de alto padrão: exame de vista gratuito com equipamentos modernos para diagnóstico preciso, confecção de óculos de grau com lentes das melhores marcas incluindo opções monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos premium como anti-reflexo Crizal, proteção contra luz azul de dispositivos, lentes fotocromáticas Transitions e proteção UV total. Trabalhamos também com lentes de contato diárias e de uso prolongado.',
      'No São João você encontra as marcas mais elegantes do mercado óptico: Ray-Ban com modelos clássicos, Oakley para esportes, Persol italiano, Arnette, Chilli Beans e diversas armações de designer. A Ótica Gouveia se diferencia pelo atendimento refinado - ajudamos você a escolher a armação perfeita para seu estilo. Parcelamos em até 12x sem juros, aceitamos convênios e planos de saúde, com condições especiais para pagamento à vista.',
      'O São João está localizado em posição privilegiada em Curitiba, próximo ao Mercês, Centro, Batel, Alto da Glória e Juvevê. O bairro combina tranquilidade residencial com fácil acesso aos principais pontos da cidade. A Ótica Gouveia entrega em todo o São João e bairros adjacentes, garantindo praticidade para clientes que valorizam qualidade e conforto.',
      'Morador do São João, sua visão merece cuidado profissional! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita no São João para compras acima de R$ 250,00. Ótica Gouveia São João - tradição e elegância há mais de 40 anos!'
    ],
  ...
  'fanny': {
    ...
    description: [
      'Famílias do Fanny, a Ótica Gouveia é sua parceira em cuidados visuais para todas as idades! O Fanny é um bairro residencial tradicional de Curitiba, localizado na região sul da cidade, conhecido por seu forte senso de comunidade, vizinhança acolhedora e famílias que valorizam qualidade de vida. Com mais de 40 anos de tradição no mercado óptico curitibano, a Ótica Gouveia está próxima ao Fanny (apenas 8 minutos de carro) e oferece entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para toda a família: exame de vista gratuito para adultos, idosos e crianças com equipamentos modernos, confecção de óculos de grau com lentes de alta qualidade incluindo opções monofocais infantis e adultas, bifocais e multifocais progressivas. Disponibilizamos tratamentos essenciais como anti-reflexo, proteção contra luz azul de telas, lentes fotocromáticas Transitions e proteção UV 400. Trabalhamos também com lentes de contato para todas as necessidades.',
      'No Fanny você encontra armações para todas as idades e estilos: Ray-Ban, Oakley, Arnette, Chilli Beans, armações infantis coloridas e divertidas, e diversas opções nacionais acessíveis. A Ótica Gouveia se diferencia pelo atendimento familiar - cuidamos da visão de avós, pais e filhos com a mesma dedicação. Parcelamos em até 12x sem juros, aceitamos convênios e planos de saúde, com condições especiais para famílias.',
      'O Fanny está localizado na região sul de Curitiba, próximo ao Hauer, Boqueirão, Lindóia do Sul e Guabirotuba. O bairro possui boa infraestrutura, comércio local, escolas e áreas de lazer. É muito valorizado por famílias que buscam ambiente tranquilo e seguro. A Ótica Gouveia atende toda essa região familiar com qualidade e carinho há décadas.',
      'Família do Fanny, agende o exame de vista gratuito para todos! Entre em contato pelo WhatsApp (41) 99955-0667 e cuide da visão de toda a família. Entrega gratuita no Fanny para compras acima de R$ 250,00. Funcionamos de segunda a sexta das 9h às 18h e sábados das 9h às 13h. Ótica Gouveia Fanny - qualidade familiar há mais de 40 anos!'
    ],
  ...
  'sao-francisco': {
    ...
    description: [
      'Moradores e frequentadores do São Francisco, a Ótica Gouveia oferece elegância para o bairro mais histórico de Curitiba! O São Francisco é o coração cultural da capital paranaense, abrigando a icônica Igreja da Ordem, o Largo da Ordem, centros culturais, galerias de arte e a famosa Feira do Largo aos domingos. Com atmosfera boêmia e histórica, o bairro atrai moradores sofisticados, artistas e apreciadores de cultura. Com mais de 40 anos de tradição, a Ótica Gouveia oferece produtos premium e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos de alto padrão para clientes exigentes: exame de vista gratuito com equipamentos modernos, confecção de óculos de grau com lentes das melhores marcas mundiais incluindo Zeiss, Hoya e Varilux. Disponibilizamos tratamentos premium como anti-reflexo Crizal, proteção contra luz azul para quem trabalha em ateliês e galerias, lentes fotocromáticas Transitions e proteção UV total. Trabalhamos também com lentes de contato diárias premium.',
      'No São Francisco você encontra armações com personalidade: Ray-Ban clássicos atemporais, Persol italiano, Arnette, Chilli Beans com designs únicos e diversas armações de designer independentes. A Ótica Gouveia se diferencia pelo atendimento cultural e refinado - ajudamos você a escolher óculos que expressem sua personalidade artística e sofisticada. Parcelamos em até 12x sem juros, aceitamos convênios e condições especiais para artistas e produtores culturais.',
      'O São Francisco está localizado no Centro Histórico de Curitiba, próximo ao Centro, Alto da Glória, Batel e com fácil acesso às principais atrações culturais da cidade. O bairro respira história e arte, sendo ponto de encontro de artistas, músicos e apreciadores da boa cultura. A Ótica Gouveia entrega em todo o São Francisco e bairros adjacentes, combinando tradição com praticidade.',
      'Cliente do São Francisco, cuide da sua visão com elegância histórica! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita no São Francisco para compras acima de R$ 250,00. Ótica Gouveia São Francisco - tradição e cultura em óculos há mais de 40 anos!'
    ],
  ...
  'barigui': {
    ...
    description: [
      'Moradores da região do Barigui, a Ótica Gouveia oferece qualidade premium para uma das áreas mais nobres de Curitiba! A região do Barigui é conhecida pelo icônico Parque Barigui com seus lagos, áreas verdes, pistas de caminhada e infraestrutura de lazer completa. Moradores dessa região valorizam qualidade de vida, saúde e serviços de excelência. Com mais de 40 anos de tradição no mercado óptico, a Ótica Gouveia oferece produtos premium e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos de alto padrão para quem vive e pratica esportes no Barigui: exame de vista gratuito com tecnologia avançada, confecção de óculos de grau com lentes das melhores marcas mundiais incluindo Zeiss, Hoya e Varilux. Disponibilizamos tratamentos premium como anti-reflexo Crizal Sapphire, proteção contra luz azul, lentes fotocromáticas Transitions XTRActive perfeitas para atividades ao ar livre e proteção UV total. Óculos esportivos com grau para corrida, ciclismo e caminhada no parque.',
      'Na região do Barigui você encontra as grifes mais desejadas: Ray-Ban com coleções exclusivas, Oakley de alta performance para esportes, Persol italiano, Prada, Tom Ford e diversas armações de designer. A Ótica Gouveia se diferencia pelo atendimento consultivo premium - proporcionamos uma experiência completa de escolha para clientes exigentes. Parcelamos em até 12x sem juros, com condições especiais para pagamento à vista.',
      'A região do Barigui engloba bairros como Santo Inácio, Mercês, Cascatinha, Bigorrilho e Champagnat, próximo ao ParkShopping Barigui e com fácil acesso ao parque. A área é sinônimo de qualidade de vida, com condomínios de alto padrão, infraestrutura completa e natureza preservada. A Ótica Gouveia entrega em toda a região do Barigui com a excelência que você merece.',
      'Morador do Barigui, cuide da sua visão com qualidade premium! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos esportivos e de grau em casa. Entrega gratuita na região do Barigui para compras acima de R$ 250,00. Ótica Gouveia - excelência para quem curte o Parque Barigui há mais de 40 anos!'
    ],
  ...
  'centro-civico': {
    ...
    description: [
      'Profissionais do Centro Cívico, a Ótica Gouveia oferece elegância executiva para o coração administrativo de Curitiba! O Centro Cívico é onde se concentra o poder público do Paraná, abrigando o Palácio Iguaçu, sede do Governo do Estado, o icônico Museu Oscar Niemeyer (MON), secretarias e diversos órgãos públicos. Profissionais que trabalham na região buscam sofisticação e praticidade. Com mais de 40 anos de tradição, a Ótica Gouveia oferece produtos executivos premium e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos de excelência para executivos e servidores públicos: exame de vista gratuito com equipamentos de última geração, confecção de óculos de grau com lentes premium das marcas mais prestigiadas incluindo Zeiss, Hoya e Varilux. Disponibilizamos tratamentos especiais para ambiente de escritório como anti-reflexo Crizal Prevencia, proteção contra luz azul de computadores, lentes fotocromáticas Transitions para reuniões externas e proteção UV total.',
      'No Centro Cívico você encontra as armações mais elegantes do mercado: Ray-Ban clássicos, Persol italiano, Prada, Boss, Montblanc e diversas grifes executivas. A Ótica Gouveia se diferencia pelo atendimento sob medida para profissionais - ajudamos você a escolher óculos que transmitam autoridade e sofisticação. Parcelamos em até 12x sem juros, aceitamos convênios de servidores públicos e condições especiais para pagamento à vista.',
      'O Centro Cívico está localizado na região norte de Curitiba, próximo ao Alto da Glória, Juvevê, Cabral e Centro. O bairro é frequentado por milhares de profissionais diariamente, com infraestrutura completa, restaurantes executivos e fácil acesso de transporte. A Ótica Gouveia entrega no Centro Cívico durante seu horário de trabalho, garantindo máxima praticidade.',
      'Profissional do Centro Cívico, cuide da sua imagem com elegância! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos executivos no trabalho. Entrega gratuita no Centro Cívico para compras acima de R$ 250,00. Ótica Gouveia Centro Cívico - sofisticação para profissionais há mais de 40 anos!'
    ],
  ...
  'capao-da-imbuia': {
    ...
    heroSubtitle: 'Natureza e Qualidade Visual',
    description: [
      'Moradores do Capão da Imbuia, a Ótica Gouveia oferece qualidade para quem vive perto do zoológico! O Capão da Imbuia é um bairro residencial encantador de Curitiba, famoso pelo Parque Capão da Imbuia que abriga o Zoológico Municipal, Museu de História Natural e vastas áreas verdes. Famílias que escolheram morar aqui valorizam o contato com a natureza e qualidade de vida. Com mais de 40 anos de tradição, a Ótica Gouveia oferece produtos de qualidade e entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para toda a família: exame de vista gratuito para adultos e crianças com equipamentos modernos, confecção de óculos de grau com lentes de alta qualidade incluindo opções monofocais infantis e adultas, bifocais e multifocais progressivas. Disponibilizamos tratamentos especiais como anti-reflexo, proteção contra luz azul de telas, lentes fotocromáticas Transitions perfeitas para passeios no zoológico e proteção UV 400.',
      'No Capão da Imbuia você encontra armações para todas as idades e aventuras: Ray-Ban clássicos, Oakley para atividades ao ar livre, Arnette, Chilli Beans, armações infantis resistentes e coloridas para as crianças e diversas opções nacionais acessíveis. A Ótica Gouveia se diferencia pelo atendimento familiar - cuidamos da visão de toda a família com atenção especial. Parcelamos em até 12x sem juros, aceitamos convênios e planos de saúde.',
      'O Capão da Imbuia está localizado na zona leste de Curitiba, próximo ao Cajuru, Jardim das Américas, Tarumã e Guabirotuba. O bairro é valorizado por famílias que buscam ambiente tranquilo com fácil acesso à natureza. Além do zoológico, a região conta com boa infraestrutura, escolas e comércio local. A Ótica Gouveia entrega em todo o Capão da Imbuia e bairros vizinhos.',
      'Família do Capão da Imbuia, cuide da visão de todos antes do próximo passeio no zoo! Agende exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba os óculos de toda a família em casa. Entrega gratuita no Capão da Imbuia para compras acima de R$ 250,00. Ótica Gouveia - qualidade familiar perto do zoológico há mais de 40 anos!'
    ],
  ...
  'bocaiuva-do-sul': {
    ...
    metaDescription: 'Ótica para Bocaiúva do Sul. Loja no Umbará com delivery via motoboy. Óculos de grau, sol e lentes de contato. Compras acima de R$250 com entrega inclusa!',
  ...
  'cerro-azul': {
    ...
    title: 'Ótica Cerro Azul PR | Capital da Laranja | Óculos | Ótica Gouveia',
    metaDescription: 'Ótica para Cerro Azul, a Capital da Laranja. Entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis!',
    keywords: [...generateKeywords('Cerro Azul', 'cidade'), 'ótica cerro azul paraná', 'ótica capital da laranja', 'óculos vale do ribeira'],
    heroTitle: 'Ótica Gouveia para Cerro Azul',
    heroSubtitle: 'Qualidade da Capital para a Capital da Laranja',
    description: [
      'Moradores de Cerro Azul, a Ótica Gouveia oferece qualidade para a famosa Capital da Laranja do Paraná! Cerro Azul é uma cidade encantadora localizada no Vale do Ribeira, região norte do estado, conhecida nacionalmente por sua produção de laranjas e frutas cítricas que abastecem mercados de todo o Brasil. Com paisagens montanhosas, rios cristalinos e clima tropical, a cidade atrai moradores que valorizam vida no campo e tradição agrícola. A Ótica Gouveia, com mais de 40 anos de tradição no mercado óptico curitibano, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos ideais para quem trabalha na agricultura: exame de vista gratuito com equipamentos modernos para diagnóstico preciso, confecção de óculos de grau com lentes resistentes incluindo monofocais para miopia, hipermetropia e astigmatismo, lentes bifocais e multifocais progressivas. Disponibilizamos tratamentos essenciais para trabalho ao ar livre: anti-reflexo, proteção contra luz azul, lentes fotocromáticas Transitions que escurecem automaticamente no sol intenso do campo e proteção UV 400 fundamental para preservar a saúde ocular durante as colheitas.',
      'Em Cerro Azul você encontra as melhores marcas do mercado com durabilidade garantida: Ray-Ban clássicos com proteção solar, Oakley resistentes para atividades no campo, Arnette, Chilli Beans e armações nacionais de alta qualidade e preço acessível. A Ótica Gouveia oferece atendimento familiar - assim como a tradição das famílias produtoras de laranja de Cerro Azul, cuidamos de cada cliente com atenção individual. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Cerro Azul está localizada a aproximadamente 1 hora de Curitiba, com acesso pela PR-092. A cidade oferece turismo rural, pomares abertos para visitação durante a safra, festa da laranja, cachoeiras e trilhas ecológicas. O Rio Ribeira corta a região oferecendo belas paisagens. Moradores do centro, bairros e zona rural - incluindo as comunidades produtoras de citros - podem contar com nossos serviços.',
      'Produtor rural ou morador de Cerro Azul, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição e qualidade para a Capital da Laranja há mais de 40 anos!'
    ],
    characteristics: 'Capital da Laranja com produção citrícola e Vale do Ribeira',
    nearbyLandmarks: ['Centro de Cerro Azul', 'Pomares de Laranja', 'Rio Ribeira', 'Cachoeiras'],
  ...
  'doutor-ulysses': {
    ...
    title: 'Ótica Doutor Ulysses PR | Óculos de Grau e Sol | Ótica Gouveia',
    metaDescription: 'Ótica para Doutor Ulysses com entrega. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Atendemos toda a cidade!',
    keywords: [...generateKeywords('Doutor Ulysses', 'cidade'), 'ótica doutor ulysses paraná', 'óculos dr ulysses pr'],
    heroTitle: 'Ótica Gouveia para Doutor Ulysses',
    heroSubtitle: 'Qualidade da Capital para o Interior Paranaense',
    description: [
      'Moradores de Doutor Ulysses, a Ótica Gouveia leva qualidade da capital para sua cidade! Doutor Ulysses é uma cidade acolhedora localizada no extremo norte da região metropolitana de Curitiba, no Vale do Ribeira, conhecida por sua vocação agrícola, produção de frutas e hortaliças, paisagens rurais preservadas e comunidades tradicionais que mantêm viva a cultura do interior paranaense. Com moradores trabalhadores que valorizam serviços de confiança, Doutor Ulysses merece atendimento de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para quem trabalha e vive no campo: exame de vista gratuito com equipamentos modernos para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes resistentes incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos essenciais para trabalho rural: anti-reflexo para leitura, proteção contra luz azul, lentes fotocromáticas Transitions que se adaptam automaticamente à luz solar intensa e proteção UV 400 fundamental para quem passa o dia ao ar livre.',
      'Em Doutor Ulysses você encontra as melhores marcas com durabilidade para o trabalho no campo: Ray-Ban com proteção solar, Oakley resistentes para atividades agrícolas, Arnette, Chilli Beans e armações nacionais robustas de excelente qualidade. A Ótica Gouveia oferece atendimento acolhedor e familiar - cada cliente recebe atenção individual para escolher a armação ideal. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde para facilitar seu acesso.',
      'Doutor Ulysses está localizada a aproximadamente 1h30 de Curitiba, com acesso pela PR-092 atravessando o Vale do Ribeira. A cidade oferece turismo rural, pousadas rústicas, comida caseira tradicional do interior e contato direto com a natureza preservada da região. A comunidade valoriza tradições e eventos religiosos que mantêm a cultura viva.',
      'Morador ou produtor rural de Doutor Ulysses, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição e qualidade para o interior paranaense há mais de 40 anos!'
    ],
    characteristics: 'Cidade rural no Vale do Ribeira com produção agrícola',
    nearbyLandmarks: ['Centro de Doutor Ulysses', 'Vale do Ribeira', 'Zona Rural'],
  ...
  'tunas-do-parana': {
    ...
    title: 'Ótica Tunas do Paraná PR | Óculos de Grau e Sol | Ótica Gouveia',
    metaDescription: 'Ótica para Tunas do Paraná com entrega. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Qualidade para sua cidade!',
    keywords: [...generateKeywords('Tunas do Paraná', 'cidade'), 'ótica tunas paraná', 'óculos tunas do parana pr'],
    heroTitle: 'Ótica Gouveia para Tunas do Paraná',
    heroSubtitle: 'Qualidade da Capital para a Serra Paranaense',
    description: [
      'Moradores de Tunas do Paraná, a Ótica Gouveia oferece qualidade para sua cidade serrana! Tunas do Paraná é uma cidade encantadora localizada na Serra do Mar, conhecida por suas paisagens montanhosas deslumbrantes, vegetação de Mata Atlântica preservada, cachoeiras cristalinas e clima ameno de altitude. Com moradores que valorizam vida tranquila em contato com a natureza e tradições do interior, Tunas do Paraná merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos ideais para quem vive na serra: exame de vista gratuito com equipamentos de última geração para diagnóstico preciso, confecção de óculos de grau com lentes resistentes incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos especiais para atividades ao ar livre: anti-reflexo multicamadas, proteção contra luz azul, lentes fotocromáticas Transitions XTRActive que escurecem mesmo dentro do carro e proteção UV 400 essencial para a altitude serrana.',
      'Em Tunas do Paraná você encontra as melhores marcas do mercado óptico: Ray-Ban clássicos com proteção solar, Oakley resistentes para trilhas e aventuras, Arnette, Chilli Beans e armações nacionais de qualidade. A Ótica Gouveia oferece atendimento familiar e acolhedor - cada cliente recebe atenção individual para escolher a armação perfeita para seu estilo de vida serrano. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Tunas do Paraná está localizada a aproximadamente 50 minutos de Curitiba, com acesso pela BR-116. A cidade é portal para trilhas ecológicas na Serra do Mar, cachoeiras escondidas, pousadas rústicas e restaurantes de comida caseira serrana. O clima fresco e as paisagens nebulosas atraem turistas e moradores que buscam qualidade de vida.',
      'Morador de Tunas do Paraná, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição e qualidade para a serra paranaense há mais de 40 anos!'
    ],
    characteristics: 'Cidade serrana com Mata Atlântica e ecoturismo',
    nearbyLandmarks: ['Centro de Tunas do Paraná', 'Serra do Mar', 'Cachoeiras', 'Trilhas Ecológicas'],
  ...
  'adrianopolis': {
    ...
    title: 'Ótica Adrianópolis PR | Vale do Ribeira | Óculos | Ótica Gouveia',
    metaDescription: 'Ótica para Adrianópolis no Vale do Ribeira. Entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis!',
    keywords: [...generateKeywords('Adrianópolis', 'cidade'), 'ótica adrianopolis paraná', 'óculos vale do ribeira', 'ótica caverna do diabo'],
    heroTitle: 'Ótica Gouveia para Adrianópolis',
    heroSubtitle: 'Qualidade da Capital para o Vale do Ribeira',
    description: [
      'Moradores de Adrianópolis, a Ótica Gouveia oferece qualidade para uma das cidades mais belas do Vale do Ribeira! Adrianópolis é uma cidade histórica localizada na divisa do Paraná com São Paulo, conhecida por seu rico patrimônio natural, cavernas impressionantes, rios cristalinos e comunidades tradicionais quilombolas que preservam a cultura afro-brasileira. Com paisagens exuberantes do Vale do Ribeira e moradores que valorizam tradição e natureza, Adrianópolis merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos: exame de vista gratuito com equipamentos modernos para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos especiais para quem vive e trabalha em contato com a natureza: anti-reflexo multicamadas, proteção contra luz azul, lentes fotocromáticas Transitions ideais para atividades ao ar livre e proteção UV 400 fundamental para a saúde ocular.',
      'Em Adrianópolis você encontra as melhores marcas do mercado óptico: Ray-Ban com proteção solar clássica, Oakley resistentes para aventuras e espeleologia, Arnette, Chilli Beans e armações nacionais de qualidade e durabilidade. A Ótica Gouveia oferece atendimento acolhedor - cada cliente recebe atenção individual para escolher a armação ideal. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Adrianópolis está localizada a aproximadamente 1h30 de Curitiba, com acesso pela PR-092. A cidade é famosa pela Caverna do Diabo (uma das maiores do Brasil), Parque Estadual das Lauráceas, comunidades quilombolas como a do Córrego do Franco, Rio Ribeira para pesca e esportes náuticos, e turismo de aventura. O patrimônio histórico e natural atrai visitantes de todo o país.',
      'Morador de Adrianópolis, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição e qualidade para o Vale do Ribeira há mais de 40 anos!'
    ],
    characteristics: 'Cidade histórica no Vale do Ribeira com cavernas e quilombos',
    nearbyLandmarks: ['Caverna do Diabo', 'Parque das Lauráceas', 'Rio Ribeira', 'Comunidades Quilombolas'],
    distanceFromStore: 'Aproximadamente 1h30 de carro',
    type: 'cidade',
    region: 'Região Metropolitana de Curitiba'
  },
  ...
  'balsa-nova': {
    ...
    metaDescription: 'Ótica para Balsa Nova com entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Atendemos toda a cidade!',
    keywords: [...generateKeywords('Balsa Nova', 'cidade'), 'ótica balsa nova paraná', 'óculos balsa nova pr', 'ótica campos gerais'],
    heroTitle: 'Ótica Gouveia para Balsa Nova',
    heroSubtitle: 'Qualidade da Capital para os Campos Gerais',
    description: [
      'Moradores de Balsa Nova, a Ótica Gouveia traz qualidade da capital para sua cidade nos Campos Gerais! Balsa Nova é uma cidade encantadora localizada a oeste da região metropolitana de Curitiba, conhecida por suas paisagens campestres deslumbrantes, produção agrícola diversificada, turismo rural crescente e qualidade de vida privilegiada. Com fazendas históricas, campos naturais e moradores que valorizam vida tranquila no interior, Balsa Nova merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Balsa Nova: exame de vista gratuito com equipamentos de última geração, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos ideais para vida no campo: anti-reflexo multicamadas, proteção contra luz azul para uso de computadores, lentes fotocromáticas Transitions perfeitas para atividades rurais e proteção UV 400 essencial para trabalho ao ar livre.',
      'Em Balsa Nova você encontra as melhores marcas do mercado óptico com preços acessíveis: Ray-Ban clássicos com proteção solar, Oakley resistentes para atividades agrícolas e equestres, Arnette, Chilli Beans e armações nacionais de qualidade. A Ótica Gouveia oferece atendimento personalizado - cada cliente recebe atenção individual. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Balsa Nova está localizada a aproximadamente 40 minutos de Curitiba pela BR-277, com acesso fácil e paisagens deslumbrantes durante o trajeto. A cidade oferece turismo rural, fazendas abertas para visitação, restaurantes de comida tropeira, eventos campeiros e proximidade com os Campos Gerais paranaenses. Moradores do centro, bairros e propriedades rurais podem receber seus óculos em casa.',
      'Morador de Balsa Nova, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita em Balsa Nova para compras acima de R$ 250,00. Ótica Gouveia - tradição e qualidade para os Campos Gerais há mais de 40 anos!'
    ],
    characteristics: 'Cidade dos Campos Gerais com turismo rural e fazendas',
    nearbyLandmarks: ['Centro de Balsa Nova', 'Campos Gerais', 'Fazendas Históricas', 'BR-277'],
    distanceFromStore: 'Aproximadamente 40 minutos de carro',
    type: 'cidade',
    region: 'Região Metropolitana de Curitiba'
  },
  ...
  'contenda': {
    name: 'Contenda',
    slug: '/otica-contenda',
    title: 'Ótica Contenda PR | Óculos de Grau e Sol | Ótica Gouveia',
    metaDescription: 'Ótica para Contenda com entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista gratuito. Qualidade para você!',
    keywords: [...generateKeywords('Contenda', 'cidade'), 'ótica contenda paraná', 'óculos contenda pr', 'ótica sul curitiba'],
    heroTitle: 'Ótica Gouveia para Contenda',
    heroSubtitle: 'Qualidade da Capital para o Interior Paranaense',
    description: [
      'Moradores de Contenda, a Ótica Gouveia traz qualidade da capital para sua cidade! Contenda é uma cidade acolhedora localizada ao sul da região metropolitana de Curitiba, conhecida por sua vocação agrícola, produção de grãos e hortaliças, paisagens rurais tranquilas e comunidade trabalhadora que valoriza tradição e bom atendimento. Com famílias que buscam serviços de qualidade sem precisar ir até a capital, Contenda merece atenção especial. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Contenda: exame de vista gratuito com equipamentos modernos para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos ideais para trabalho no campo: anti-reflexo multicamadas, proteção contra luz azul, lentes fotocromáticas Transitions que escurecem automaticamente no sol e proteção UV 400 essencial para atividades rurais.',
      'Em Contenda você encontra as melhores marcas com preços acessíveis: Ray-Ban clássicos, Oakley resistentes para o trabalho agrícola, Arnette, Chilli Beans e armações nacionais de alta qualidade. A Ótica Gouveia oferece atendimento familiar e acolhedor - cada cliente recebe atenção individual para escolher a armação perfeita. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde para facilitar seu acesso.',
      'Contenda está localizada a aproximadamente 40 minutos de Curitiba pela BR-476, com acesso fácil e estradas em bom estado. A cidade oferece tranquilidade do interior, eventos agrícolas, festas tradicionais e proximidade com Araucária e Lapa. Moradores do centro, bairros e zona rural podem receber seus óculos em casa com nossa entrega gratuita.',
      'Morador de Contenda, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita em Contenda para compras acima de R$ 250,00. Ótica Gouveia - tradição e qualidade para o interior paranaense há mais de 40 anos!'
    ],
    characteristics: 'Cidade agrícola ao sul de Curitiba com tradição rural',
    nearbyLandmarks: ['Centro de Contenda', 'Zona Rural', 'BR-476'],
    distanceFromStore: 'Aproximadamente 40 minutos de carro',
    type: 'cidade',
    region: 'Região Metropolitana de Curitiba'
  },
  ...
  'quitandinha': {
    ...
    title: 'Ótica Quitandinha PR | Óculos de Grau e Sol | Ótica Gouveia',
    metaDescription: 'Ótica para Quitandinha com entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Atendemos toda a cidade!',
    keywords: [...generateKeywords('Quitandinha', 'cidade'), 'ótica quitandinha paraná', 'óculos quitandinha pr', 'ótica interior paraná'],
    heroTitle: 'Ótica Gouveia para Quitandinha',
    heroSubtitle: 'Qualidade da Capital para o Interior Paranaense',
    description: [
      'Moradores de Quitandinha, a Ótica Gouveia traz qualidade da capital para sua cidade! Quitandinha é uma cidade acolhedora localizada ao sul da região metropolitana de Curitiba, conhecida por sua forte vocação agrícola, produção de batatas e hortaliças que abastecem a capital, paisagens rurais encantadoras e comunidade trabalhadora que mantém vivas as tradições do interior. Com famílias que valorizam bom atendimento e serviços de confiança, Quitandinha merece atenção especial. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Quitandinha: exame de vista gratuito com equipamentos de última geração para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos ideais para trabalho no campo: anti-reflexo para leitura, proteção contra luz azul de telas, lentes fotocromáticas Transitions que escurecem no sol e proteção UV 400 fundamental para atividades agrícolas.',
      'Em Quitandinha você encontra as melhores marcas com preços acessíveis: Ray-Ban clássicos, Oakley resistentes para trabalho rural, Arnette, Chilli Beans e armações nacionais de excelente qualidade. A Ótica Gouveia oferece atendimento familiar - cada cliente recebe atenção individual para escolher a armação perfeita. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Quitandinha está localizada a aproximadamente 45 minutos de Curitiba pela BR-116, com acesso fácil e estradas em bom estado. A cidade oferece tranquilidade do interior, festas tradicionais, feiras agrícolas e proximidade com Mandirituba e Tijucas do Sul. Moradores do centro, bairros e zona rural podem receber seus óculos em casa.',
      'Morador ou produtor rural de Quitandinha, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita em Quitandinha para compras acima de R$ 250,00. Ótica Gouveia - tradição para o interior há mais de 40 anos!'
    ],
    characteristics: 'Cidade agrícola produtora de batatas e hortaliças',
    nearbyLandmarks: ['Centro de Quitandinha', 'Zona Rural', 'BR-116'],
  ...
  'tijucas-do-sul': {
    ...
    title: 'Ótica Tijucas do Sul PR | Ecoturismo | Óculos | Ótica Gouveia',
    metaDescription: 'Ótica para Tijucas do Sul com entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Qualidade para ecoturistas!',
    keywords: [...generateKeywords('Tijucas do Sul', 'cidade'), 'ótica tijucas sul', 'óculos tijucas do sul pr', 'ótica cachoeiras tijucas'],
    heroTitle: 'Ótica Gouveia para Tijucas do Sul',
    heroSubtitle: 'Qualidade da Capital para a Terra das Cachoeiras',
    description: [
      'Moradores de Tijucas do Sul, a Ótica Gouveia oferece qualidade para a terra das cachoeiras! Tijucas do Sul é uma cidade deslumbrante localizada ao sul da região metropolitana de Curitiba, conhecida nacionalmente por suas cachoeiras cristalinas, trilhas ecológicas, turismo de aventura e contato direto com a natureza preservada. Com paisagens de tirar o fôlego e moradores que valorizam vida saudável em harmonia com o meio ambiente, Tijucas do Sul merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega gratuita via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos ideais para aventureiros e ecoturistas: exame de vista gratuito com equipamentos de última geração para diagnóstico preciso, confecção de óculos de grau com lentes resistentes incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos especiais para atividades ao ar livre: anti-reflexo, proteção contra luz azul, lentes fotocromáticas Transitions XTRActive que escurecem intensamente no sol e óculos de sol esportivos com proteção UV 400 para trilhas e cachoeiras.',
      'Em Tijucas do Sul você encontra as melhores marcas para aventura: Ray-Ban clássicos, Oakley com tecnologia esportiva para trilhas e esportes radicais, Arnette, Chilli Beans e armações resistentes à água e impacto. A Ótica Gouveia oferece consultoria especializada para escolher óculos adequados a cada atividade. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Tijucas do Sul está localizada a aproximadamente 50 minutos de Curitiba pela BR-376, com acesso fácil e paisagens incríveis. A cidade é famosa pela Cachoeira do Tigre Preto, trilhas na Serra do Mar, pousadas ecológicas, restaurantes de comida caseira e eventos de ecoturismo. Moradores do centro, bairros e áreas rurais podem receber seus óculos em casa.',
      'Aventureiro ou morador de Tijucas do Sul, cuide da sua visão para explorar mais cachoeiras! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667 e receba seus óculos em casa. Entrega gratuita em Tijucas do Sul para compras acima de R$ 250,00. Ótica Gouveia - qualidade para exploradores há mais de 40 anos!'
    ],
    characteristics: 'Terra das cachoeiras com ecoturismo e trilhas',
    nearbyLandmarks: ['Cachoeira do Tigre Preto', 'Serra do Mar', 'Trilhas Ecológicas', 'Centro de Tijucas do Sul'],
    distanceFromStore: 'Aproximadamente 50 minutos de carro',
    type: 'cidade',
    region: 'Região Metropolitana de Curitiba'
  },
  ...
  'agudos-do-sul': {
    ...
    title: 'Ótica Agudos do Sul PR | Óculos de Grau e Sol | Ótica Gouveia',
    metaDescription: 'Ótica para Agudos do Sul com entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Qualidade para você!',
    keywords: [...generateKeywords('Agudos do Sul', 'cidade'), 'ótica agudos sul', 'óculos agudos do sul pr', 'ótica extremo sul rmc'],
    heroTitle: 'Ótica Gouveia para Agudos do Sul',
    heroSubtitle: 'Qualidade da Capital para o Extremo Sul',
    description: [
      'Moradores de Agudos do Sul, a Ótica Gouveia leva qualidade da capital para sua cidade! Agudos do Sul é uma cidade acolhedora localizada no extremo sul da região metropolitana de Curitiba, conhecida por sua vocação agrícola, produção de grãos e frutas, paisagens rurais tranquilas e comunidade unida que mantém vivas as tradições do interior paranaense. Com moradores trabalhadores que valorizam simplicidade e bom atendimento, Agudos do Sul merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Agudos do Sul: exame de vista gratuito com equipamentos modernos para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos ideais para trabalho no campo: anti-reflexo para leitura, proteção contra luz azul, lentes fotocromáticas Transitions que escurecem automaticamente no sol intenso e proteção UV 400 essencial para atividades agrícolas.',
      'Em Agudos do Sul você encontra as melhores marcas com preços justos: Ray-Ban clássicos, Oakley resistentes para trabalho rural, Arnette, Chilli Beans e armações nacionais duráveis de qualidade. A Ótica Gouveia oferece atendimento familiar - cada cliente recebe atenção individual para escolher a armação perfeita. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Agudos do Sul está localizada a aproximadamente 1 hora de Curitiba pela BR-116, com acesso fácil e paisagens rurais durante o trajeto. A cidade oferece tranquilidade típica do interior, festas tradicionais, feiras agrícolas e proximidade com Tijucas do Sul e a divisa com Santa Catarina. Moradores do centro, bairros e propriedades rurais podem contar com nossos serviços.',
      'Morador ou produtor rural de Agudos do Sul, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição para o interior paranaense há mais de 40 anos!'
    ],
    characteristics: 'Cidade agrícola no extremo sul da região metropolitana',
    nearbyLandmarks: ['Centro de Agudos do Sul', 'Zona Rural', 'BR-116'],
    distanceFromStore: 'Aproximadamente 1 hora de carro',
    type: 'cidade',
    region: 'Região Metropolitana de Curitiba'
  },
  ...
  'pien': {
    ...
    metaDescription: 'Ótica para Piên na fronteira PR/SC. Entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis!',
    keywords: [...generateKeywords('Piên', 'cidade'), 'ótica pien paraná', 'óculos pien pr', 'ótica fronteira sc', 'ótica colônia alemã'],
    heroTitle: 'Ótica Gouveia para Piên',
    heroSubtitle: 'Qualidade da Capital para a Fronteira',
    description: [
      'Moradores de Piên, a Ótica Gouveia traz qualidade da capital para sua cidade na fronteira! Piên é uma cidade encantadora localizada no sul do Paraná, na divisa com Santa Catarina, conhecida por sua forte influência da colonização alemã, arquitetura germânica preservada, produção agrícola diversificada e tradições culturais europeias. Com paisagens bucólicas, moradores trabalhadores e comunidade que valoriza tradição e qualidade, Piên merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Piên: exame de vista gratuito com equipamentos de última geração para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos ideais para trabalho e lazer: anti-reflexo multicamadas, proteção contra luz azul, lentes fotocromáticas Transitions e proteção UV 400 para atividades ao ar livre.',
      'Em Piên você encontra as melhores marcas do mercado óptico com preços acessíveis: Ray-Ban clássicos, Oakley resistentes para trabalho agrícola, Arnette, Chilli Beans e armações nacionais de qualidade alemã. A Ótica Gouveia oferece atendimento familiar e acolhedor - cada cliente recebe atenção individual. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Piên está localizada a aproximadamente 1h15 de Curitiba pela BR-116, com acesso fácil e paisagens charmosas. A cidade oferece festa alemã tradicional, arquitetura germânica, restaurantes de comida típica europeia, vinícolas artesanais e proximidade com Rio Negro e Santa Catarina. Moradores do centro, bairros e colônias podem contar com nossos serviços.',
      'Morador de Piên, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição que combina com Piên há mais de 40 anos!'
    ],
    characteristics: 'Cidade de colonização alemã na fronteira PR/SC',
    nearbyLandmarks: ['Centro de Piên', 'Arquitetura Alemã', 'Divisa com Santa Catarina', 'BR-116'],
  ...
  'campo-do-tenente': {
    ...
    title: 'Ótica Campo do Tenente PR | Óculos de Grau e Sol | Ótica Gouveia',
    metaDescription: 'Ótica para Campo do Tenente com entrega. Óculos de grau, sol, lentes de contato. Exame de vista grátis. Qualidade para você!',
    keywords: [...generateKeywords('Campo do Tenente', 'cidade'), 'ótica campo tenente', 'óculos campo do tenente pr', 'ótica sul paraná'],
    heroTitle: 'Ótica Gouveia para Campo do Tenente',
    heroSubtitle: 'Qualidade da Capital para o Sul Paranaense',
    description: [
      'Moradores de Campo do Tenente, a Ótica Gouveia leva qualidade da capital para sua cidade! Campo do Tenente é uma cidade acolhedora localizada no sul do Paraná, conhecida por sua vocação agrícola, produção de grãos e madeira, paisagens rurais tranquilas e comunidade trabalhadora que valoriza tradição e bom atendimento. Com clima agradável e moradores que buscam serviços de qualidade sem precisar ir até a capital, Campo do Tenente merece atenção especial. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Campo do Tenente: exame de vista gratuito com equipamentos modernos para diagnóstico preciso do seu grau, confecção de óculos de grau com lentes resistentes incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos ideais para trabalho rural: anti-reflexo para leitura, proteção contra luz azul, lentes fotocromáticas Transitions que escurecem no sol e proteção UV 400 essencial para atividades no campo.',
      'Em Campo do Tenente você encontra as melhores marcas com durabilidade garantida: Ray-Ban clássicos, Oakley resistentes para trabalho agrícola e madeireiro, Arnette, Chilli Beans e armações nacionais robustas. A Ótica Gouveia oferece atendimento familiar - cada cliente recebe atenção individual. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Campo do Tenente está localizada a aproximadamente 1h20 de Curitiba pela BR-116, com acesso fácil e paisagens rurais. A cidade oferece tranquilidade do interior, eventos agrícolas tradicionais, festas comunitárias e proximidade com Rio Negro e a divisa com Santa Catarina. Moradores do centro, bairros e zona rural podem contar com nossos serviços.',
      'Morador de Campo do Tenente, cuide da sua visão com qualidade da capital! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição para o sul paranaense há mais de 40 anos!'
    ],
    characteristics: 'Cidade agrícola e madeireira no sul do Paraná',
    nearbyLandmarks: ['Centro de Campo do Tenente', 'Zona Rural', 'BR-116'],
  ...
  'rio-negro': {
    ...
    title: 'Ótica Rio Negro PR | Cidade Histórica | Óculos | Ótica Gouveia',
    metaDescription: 'Ótica para Rio Negro na fronteira PR/SC. Entrega via motoboy. Óculos de grau, sol, lentes de contato. Exame de vista grátis!',
    keywords: [...generateKeywords('Rio Negro', 'cidade'), 'ótica rio negro paraná', 'óculos rio negro pr', 'ótica fronteira sc', 'ótica cidade germânica'],
    heroTitle: 'Ótica Gouveia para Rio Negro',
    heroSubtitle: 'Qualidade da Capital para a Cidade Histórica',
    description: [
      'Moradores de Rio Negro, a Ótica Gouveia oferece qualidade para uma das cidades mais históricas do Paraná! Rio Negro é uma cidade encantadora localizada na divisa do Paraná com Santa Catarina, conhecida por sua rica herança germânica, arquitetura europeia preservada, o belo Rio Negro que dá nome à cidade e tradições culturais que remontam à colonização alemã. Com centro histórico charmoso e moradores que valorizam cultura e qualidade, Rio Negro merece serviços de excelência. A Ótica Gouveia, com mais de 40 anos de tradição, oferece entrega via motoboy para compras acima de R$ 250,00.',
      'Nossa equipe especializada oferece serviços ópticos completos para moradores de Rio Negro: exame de vista gratuito com equipamentos de última geração para diagnóstico preciso, confecção de óculos de grau com lentes de alta qualidade incluindo monofocais, bifocais e multifocais progressivas. Disponibilizamos tratamentos elegantes: anti-reflexo multicamadas, proteção contra luz azul, lentes fotocromáticas Transitions e proteção UV 400 para passeios pelo centro histórico.',
      'Em Rio Negro você encontra armações elegantes que combinam com a tradição da cidade: Ray-Ban clássicos atemporais, Oakley para atividades ao ar livre, Arnette, Chilli Beans e armações sofisticadas nacionais e importadas. A Ótica Gouveia oferece atendimento refinado - cada cliente recebe consultoria individual. Parcelamos em até 12x sem juros, aceitamos PIX e dinheiro com desconto especial, e trabalhamos com convênios e planos de saúde.',
      'Rio Negro está localizada a aproximadamente 1h15 de Curitiba pela BR-116, com acesso fácil e paisagens encantadoras. A cidade oferece centro histórico preservado, igrejas centenárias, casarões germânicos, festival de tradição alemã, restaurantes de comida típica e proximidade com Mafra (SC). Moradores do centro, bairros e comunidades podem contar com nossos serviços.',
      'Morador de Rio Negro, cuide da sua visão com elegância e qualidade! Agende seu exame de vista gratuito pelo WhatsApp (41) 99955-0667. Entrega via motoboy para compras acima de R$ 250,00. Ótica Gouveia - tradição que combina com Rio Negro há mais de 40 anos!'
    ],
    characteristics: 'Cidade histórica germânica na fronteira PR/SC',
    nearbyLandmarks: ['Centro Histórico', 'Rio Negro', 'Igrejas Centenárias', 'Casarões Germânicos'],
    distanceFromStore: 'Aproximadamente 1h15 de carro',
    type: 'cidade',
    region: 'Região Metropolitana de Curitiba'
  },
  ...
  'ganchinho': {
    ...
    metaDescription: 'Ótica para o bairro Ganchinho em Curitiba. Loja no Umbará com delivery via motoboy. Óculos de grau, sol, lentes de contato. Compras acima de R$250 com entrega inclusa!',
    ...
    heroSubtitle: 'Loja no Umbará — Entregamos no Seu Bairro!',
    description: [
  ...
  'fazendinha': {
    ...
    metaDescription: 'Ótica para o bairro Fazendinha em Curitiba. Loja no Umbará com delivery via motoboy. Óculos de grau, sol, lentes de contato. Compras acima de R$250 com entrega inclusa!',
